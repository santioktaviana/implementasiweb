<?php include("includes/connection.php");
	...
	else if($get_method['method_name']=="get_search_recipe")
	{
	  ...
	  {	
	  		if($get_method['name']!='' AND $get_method['email']!='' AND $get_method['password']!='')
			{
				...
				if($row['email']!="")
				{
					$set['id7996964_tugas5'][]=array('msg' => "Email address already used!",'success'=>'0');
				}
				else
				{ 
					...
					$set['id7996964_tugas5'][]=array('msg' => "Register successflly...!",'success'=>'1');
			...
			{
				$set['id7996964_tugas5'][]=array('msg' => "Empty fields!",'success'=>'0');
			}
	  ...
	  else if($get_method['method_name']=="user_login")
	  {
	    ...
	    if ($num_rows > 0)
			{ 
				     ...
				     $set['id7996964_tugas5'][]=array('user_id' => $row['id'],'name'=>$row['name'],'success'=>'1');
			...
			else
			{
	 				...
	 				$set['id7996964_tugas5'][]=array('msg' =>'Login failed','success'=>'0');
	  ...
	  else if($get_method['method_name']=="user_profile")
	  {
		    ...
		    $set['id7996964_tugas5'][]=array('user_id' => $row['id'],'name'=>$row['name'],'email'=>$row['email'],'phone'=>$row['phone'],'success'=>'1');
	  ...
	  else if($get_method['method_name']=="user_profile_update")
	  {
			...
			$set['id7996964_tugas5'][]=array('msg'=>'Updated','success'=>'1');
	...
	else if($get_method['method_name']=="forgot_pass")
	{
		...
		if($row['email']!="")
		{
			...
			$set['id7996964_tugas5'][]=array('msg' => "Password has been sent on your mail!",'success'=>'1');
		}
		else
		{  	 
				
			$set['id7996964_tugas5'][]=array('msg' => "Email not found in our database!",'success'=>'0');
	...
	else if($get_method['method_name']=="recipe_rate")
  	{
	      ...
	      $total_rat_row=mysqli_fetch_assoc($total_rat_res);
					...
					echo '{"id7996964_tugas5":[{"MSG":"You have succesfully rated","rate_avg":"'.$rate_avg.'"}]}';
	        
	      }else{
	                
	        echo '{"id7996964_tugas5":[{"MSG":"You have already rated"}]}';
	      }
